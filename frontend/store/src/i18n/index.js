...
const messages = {
  en: {
    ...
    order: { orderTitle: 'Order Details', backToOrders: 'Back to Orders',  PENDING_PAYMENT: 'Pending Payment', PAID: 'Paid', SHIPPED: 'Shipped', COMPLETED: 'Completed', CANCELLED: 'Cancelled', REFUNDED: 'Refunded', UNKNOWN: 'Unknown', orderNo: 'Order No', status: 'Status', totalAmount: 'Total', createdAt: 'Date' },
    ...
    account: { ordersSubtitle: 'View and manage your orders',  paymentInitiated: 'Payment initiated',  paymentFailed: 'Payment failed, please try again', 
  ...
  'zh-CN': {
    ...
    order: { orderTitle: '订单详情', backToOrders: '返回订单列表',  PENDING_PAYMENT: '待支付', PAID: '已支付', SHIPPED: '已发货', COMPLETED: '已完成', CANCELLED: '已取消', REFUNDED: '已退款', UNKNOWN: '未知', orderNo: '订单号', status: '状态', totalAmount: '金额', createdAt: '时间' },
    ...
    account: { ordersSubtitle: '查看和管理您的订单',  paymentInitiated: '支付已发起',  paymentFailed: '支付失败，请重试', 
  ...
  'zh-TW': {
    ...
    order: { orderTitle: '訂單詳情', backToOrders: '返回訂單列表',  PENDING_PAYMENT: '待支付', PAID: '已支付', SHIPPED: '已發貨', COMPLETED: '已完成', CANCELLED: '已取消', REFUNDED: '已退款', UNKNOWN: '未知', orderNo: '訂單號', status: '狀態', totalAmount: '金額', createdAt: '時間' },
    ...
    account: { ordersSubtitle: '查看和管理您的訂單',  paymentInitiated: '支付已發起',  paymentFailed: '支付失敗，請重試', 
  ...
  ja: {
    ...
    order: { orderTitle: '注文詳細', backToOrders: '注文一覧に戻る',  PENDING_PAYMENT: '支払い待ち', PAID: '支払い済み', SHIPPED: '発送済み', COMPLETED: '完了', CANCELLED: 'キャンセル', REFUNDED: '返金済み', UNKNOWN: '不明', orderNo: '注文番号', status: 'ステータス', totalAmount: '金額', createdAt: '日時' },
    ...
    account: { ordersSubtitle: '注文の確認と管理',  paymentInitiated: '支払いが開始されました',  paymentFailed: '支払い失敗、もう一度お試しください', 
