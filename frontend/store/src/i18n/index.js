...
const messages = {
  en: {
    ...
    account: { paymentInitiated: 'Payment initiated',  paymentFailed: 'Payment failed, please try again', 
  ...
  'zh-CN': {
    ...
    account: { paymentInitiated: '支付已发起',  paymentFailed: '支付失败，请重试', 
  ...
  'zh-TW': {
    ...
    account: { paymentInitiated: '支付已發起',  paymentFailed: '支付失敗，請重試', 
  ...
  ja: {
    ...
    account: { paymentInitiated: '支払いが開始されました',  paymentFailed: '支払い失敗、もう一度お試しください', 
